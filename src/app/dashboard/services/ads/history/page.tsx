        ...
        <div className="px-4 md:px-6 pt-6 max-w-screen-2xl mx-auto pb-24 text-[#111827]">
            ...
            <div className="flex items-center gap-3 mb-7">
                ...
                <div className="flex items-center gap-2">
                    <Link href="/dashboard/services/ads/wizard"
                        className="hidden sm:flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-xl bg-purple-600 text-[#111827] hover:bg-purple-500 transition-all">
                        <Plus size={13} /> Nueva
                    </Link>
                    ...
                    {[
                        ...
                        <div key={label} className="bg-white/3 border border-[#E4E9F0] rounded-2xl p-4">
                            ...
                            <p className="text-lg font-black">
                                {loadingMetrics ? <span className="w-12 h-4 bg-[#F4F6FA] rounded animate-pulse inline-block" /> : value}
                            </p>
                        </div>
                    ))}
                    </div>
                    ...
                    return (
                        <button key={s} onClick={() => setFilter(s)}
                            className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold transition-all border whitespace-nowrap shrink-0 ${filter === s
                                ...
                                : 'bg-[#F4F6FA] border-[#E4E9F0] text-[#111827]/40 hover:border-white/25 hover:text-[#111827]/70'
                            }`}>
                            {FILTER_LABELS[s]}
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-24 gap-3">
                    ...
                    <p className="text-[#111827]/30 text-sm">Cargando campañas...</p>
                </div>
            ) : filtered.length === 0 ? (
                <div className="text-center py-20 bg-white/[0.015] border border-dashed border-[#E4E9F0] rounded-3xl">
                    <BarChart3 size={28} className="text-[#111827]/20 mx-auto mb-3" />
                    <p className="text-[#111827]/30 text-sm font-bold">Sin campañas</p>
                    <p className="text-[#111827]/20 text-xs mt-1 mb-6">No hay campañas con este filtro</p>
                    <Link href="/dashboard/services/ads/wizard"
                        className="inline-flex items-center gap-2 px-5 py-2.5 bg-purple-600 text-[#111827] text-sm font-bold rounded-xl hover:bg-purple-500 transition-all">
                        ...
                        return (
                            <div key={campaign.id}
                                ...
                                <div className="flex items-start gap-3">
                                    <div className="w-10 h-10 rounded-xl bg-[#F4F6FA] border border-[#E4E9F0] flex items-center justify-center shrink-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start gap-2 justify-between">
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-[11px] text-[#111827]/30 truncate mt-0.5">
                                        ...
                                        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-2">
                                            {campaign.dailyBudgetUSD > 0 && (
                                                <span className="text-[10px] text-[#111827]/25 font-medium">${campaign.dailyBudgetUSD}/día</span>
                                            )}
                                            <span className="text-[10px] text-[#111827]/25">{campaign.creatives?.length || 0} anuncios · {creativesWithMedia} con creativo</span>
                                            {campaign.publishedAt && (
                                                <span className="text-[10px] text-[#111827]/20">
                                        ...
                                        {loadingMetrics && !campaignMetrics ? (
                                            ...
                                            <div className="mt-3">
                                                <div className="grid grid-cols-4 gap-2">
                                                    {[
                                                        ...
                                                        <div key={label} className="bg-white/3 rounded-xl p-2.5 text-center">
                                                            ...
                                                            <p className="text-[9px] text-[#111827]/25 mt-0.5">{label}</p>
                                                        </div>
                                                    ))}
                                                </div>
                                                {/* CTR / CPM row */}
                                                {metricsExpanded && (
                                                    <div className="grid grid-cols-2 gap-2 mt-2">
                                                        <div className="bg-white/3 rounded-xl p-2.5 flex items-center gap-2">
                                                            <TrendingUp size={13} className="text-[#111827]/30" />
                                                            <div>
                                                                <p className="text-xs font-bold">{campaignMetrics!.ctr.toFixed(2)}%</p>
                                                                <p className="text-[9px] text-[#111827]/25">CTR</p>
                                                            </div>
                                                        </div>
                                                        <div className="bg-white/3 rounded-xl p-2.5 flex items-center gap-2">
                                                            <DollarSign size={13} className="text-[#111827]/30" />
                                                            <div>
                                                                <p className="text-xs font-bold">${campaignMetrics!.cpm.toFixed(2)}</p>
                                                                <p className="text-[9px] text-[#111827]/25">CPM</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                )}
                                                <button
                                                    ...
                                                    className="w-full flex items-center justify-center gap-1 text-[10px] text-[#111827]/20 hover:text-[#111827]/40 mt-1.5 transition-all">
                                            ...
                                            <div className="mt-3 p-2.5 bg-white/3 rounded-xl flex items-center gap-2">
                                                <AlertCircle size={12} className="text-[#111827]/20 shrink-0" />
                                                <p className="text-[10px] text-[#111827]/25">{campaignMetrics.error}</p>
                                            </div>
                                        ) : null}
                                    </>
                                )}
                                ...
                                <div className="flex items-center gap-2 mt-3 pt-3 border-t border-[#E4E9F0]">
                                    {campaign.status === 'READY' && (
                                        <Link href={`/dashboard/services/ads/preview/${campaign.id}`}
                                            className="flex-1 sm:flex-none text-center text-xs font-bold px-4 py-2 rounded-xl bg-purple-600 text-[#111827] hover:bg-purple-500 transition-all">
                                            Publicar →
                                        </Link>
                                    )}
                                    {campaign.status === 'DRAFT' && (
                                        <Link href={`/dashboard/services/ads/campaign/${campaign.strategyId}?edit=${campaign.id}`}
                                            className="flex-1 sm:flex-none text-center text-xs font-bold px-4 py-2 rounded-xl bg-white/8 text-[#111827]/60 hover:bg-white/15 transition-all">
                                            Continuar editando →
                                        </Link>
                                    )}
                                    ...
                                    <div className="ml-auto flex items-center gap-2">
                                        {campaign.status === 'PUBLISHED' && campaign.providerCampaignId && (
                                            <button onClick={() => fetchMetrics([campaign.id])} className="text-[#111827]/20 hover:text-[#111827]/50 transition-all">
                                        ...
                                        {confirmDelete === campaign.id ? (
                                            <div className="flex items-center gap-1.5">
                                                <span className="text-[10px] text-[#111827]/40">¿Eliminar?</span>
                                                <button
                                                ...
                                                <button
                                                    ...
                                                    className="text-[10px] font-bold px-2.5 py-1 rounded-lg bg-[#F4F6FA] border border-[#E4E9F0] text-[#111827]/40 hover:bg-[#EEF2F7] transition-all"
                                                >
                                                    Cancelar
                                                </button>
                                            </div>
                                            ...
                                            <button
                                                ...
                                                className="text-[#111827]/20 hover:text-red-400 transition-all"
